...
public class SplashActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 * !conMgr.getActiveNetworkInfo().isAvailable()) { // No connectivity -
		 * Show alert AlertDialog.Builder builder = new
		 * AlertDialog.Builder(this); builder.setMessage(
		 * "Unable to reach server, \nPlease check your connectivity.")
		 * .setTitle("Itslearning") .setCancelable(false)
		...
		// this all seems cumbersome, but I need an array to pass to the
		// ASyncTask
