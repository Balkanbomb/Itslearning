...
public class MainActivity extends Activity {
	...
	private void prepareListData() {
		...
		// Adding child data
		/*
		 * listDataHeader.add(new Article("New", "2013-10-15 10.30",
		 * "For this we will need your User stories and one or more of them will be put into the first sprint."
		 * )); listDataHeader.add(new Article("Not so new", "2013-10-14 10.30",
		 * "We will need your User stories and one or more of them will be put into the first sprint."
		 * )); listDataHeader.add(new Article("Old", "2013-10-13 10.30",
		 * "For this we will need your User stories.")); listDataHeader.add(new
		 * Article("Oldest", "2013-10-12 10.30",
		 * "For this we will need your User stories."));
		 */
		// Adding child data
