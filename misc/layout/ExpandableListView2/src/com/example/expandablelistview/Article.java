...
public class Article {
	...
	public String getArticleCourseColor() {
		return articleCourseColor;
	}
	public void setArticleCourseColor(String articleCourseColor){
		this.articleCourseColor = articleCourseColor;
	}
